 ...
 * einer, welcher das request sendet und einen Input Stram bereit h�lt sowie
...
public class Abo extends Activity {
	 ...
	 * den Textview f�r die Ausgabe. Daraufhin wird der Thread zum anmelden an
	...
	/**
	 * bei erneuter Ausf�hrung m�ssen nur der Request sowie der Handler zum
	...
	public void onRestart() {
		...
		if (Abo_Service.isInstanceCreated())
			Toast.makeText(this, "XS Abo Service l�uft bereits...",
	...
	/**
	 * f�r die Tabs wird der KeyDown f�r Back sowie Men� �berschrieben
	 */
	@Override
	public boolean onKeyDown(int keyCode, KeyEvent event) {

		// Beim Back Button wird in f�r die Tabs ein Hinweis ausgegeben, ob die
