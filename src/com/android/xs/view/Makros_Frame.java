...
public class Makros_Frame extends ListActivity {
	...
	// Abfrage, ob Element gel�scht werden soll
	 ...
	 * klicken auf ein Element f�hrt das makro aus, w�hrend langes klicken zu
	 * einer Abfrage f�hrt, ob das Makro gel�scht werden soll
	 */
	@Override
	public void onCreate(Bundle savedInstanceState) {
		...
		/**
		 * Der einfache click listener zum Ausf�hren des Makros
		 */
		lv.setOnItemClickListener(new OnItemClickListener() {

			public void onItemClick(AdapterView<?> parent, View view,
					int position, long id) {
				// geklickte Makro ausf�hren
				dialog1 = ProgressDialog.show(Makros_Frame.this, "",
						"Makro wird ausgef�hrt...", true, false);
				dialog1.show();
		...
		/**
		 * der long click listener zum l�schen eines Makros
		 */
	...
	/**
	 * Die Klasse f�hrt das makro als eigenen Task aus. Dabei wird eine
	 * Ladeanzeige gezeigt
	 * 
	 * @author Viktor Mayer
	 * 
	...
	private class ExecuteMakro extends AsyncTask<Integer, Boolean, Boolean> {
		...
		protected void onPostExecute(Boolean result) {
			if (result) {
				Toast.makeText(getBaseContext(), "Makro wurde ausgef�hrt!",
